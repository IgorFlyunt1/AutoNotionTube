#region Header
// -----------------------------------------------------------------------
//  <copyright file="AzureFunctionException.cs" company="INVENTIO AG">
...
namespace AutoNotionTube.Core.Exceptions
{
    ...
    {
        public AzureFunctionException()
        {
        }
        
        public AzureFunctionException(string message)
            : base(message)
        {
        }
        
        public AzureFunctionException(string message, Exception inner)
            : base(message, inner)
        {
        }
        
        protected AzureFunctionException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
